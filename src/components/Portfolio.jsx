    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black">
      <div className="relative">
        <div className="w-32 h-32 relative">
          ...
          <div
            className="absolute inset-2 rounded-full border-4 border-transparent border-t-pink-400 border-r-blue-500 animate-spin"
            style={{ animationDuration: "1.5s" }}
          />
          <div
            className="absolute inset-4 rounded-full border-4 border-transparent border-t-yellow-400 border-r-green-500 animate-spin"
...
const CertificateModal = ({ isOpen, onClose, certificate }) => {
  ...
  return (
    ...
    >
      <div
        className="relative max-w-6xl w-full max-h-[90vh] bg-gray-900 rounded-3xl overflow-hidden border border-cyan-500/30"
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <div
          className="absolute top-1/4 right-1/4 w-[600px] h-[600px] bg-purple-500/20 rounded-full blur-3xl animate-pulse"
      ...
      >
        ...
        >
          {/* <div className="relative w-48 h-48 mx-auto mb-12 group">
            <div
              className="absolute inset-0 rounded-full bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 animate-spin"
            ...
            <div className="flex justify-center space-x-6 pt-12">
              {[
                ...
                >
                  ...
                  <Icon
                    className="relative text-cyan-400 group-hover:text-white transition-colors"
                    size={24}
                  />
                </a>
              ))}
...
const About = () => {
  ...
  const timeline = [
    {
      ...
      desc: "Associate Frontend Developer - Singapore",
      icon: Code,
    },
    {
      year: "2022",
      title: "Promoted to Frontend Developer",
      desc: "Led multiple high-impact projects",
      icon: TrendingUp,
    },
    {
      year: "2024",
  ...
  return (
    <section
      id="about"
      className="py-32 relative overflow-hidden bg-gradient-to-b from-black via-gray-900 to-black"
    >
      <div
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            <div className="space-y-8">
              <div className="group p-8 rounded-3xl bg-gradient-to-br from-cyan-500/5 via-purple-500/5 to-transparent backdrop-blur-xl border border-cyan-500/20 hover:border-purple-500/30 transition-all duration-500 hover:scale-105">
                <p className="text-xl text-gray-300 leading-relaxed">
                  ...
                  <span className="text-purple-400 font-semibold">
                    FoodMarketHub, Singapore
                  </span>
                  , specializing in building scalable, performance-optimized web
                  applications.
                </p>
              </div>
              ...
              <div className="group p-8 rounded-3xl bg-gradient-to-br from-purple-500/5 via-pink-500/5 to-transparent backdrop-blur-xl border border-purple-500/20 hover:border-pink-500/30 transition-all duration-500 hover:scale-105">
                <p className="text-xl text-gray-300 leading-relaxed">
                  Certified by{" "}
                  <span className="text-purple-400 font-bold">Pesto Tech</span>{" "}
                  with{" "}
                  <span className="text-pink-400 font-bold">
                    4 Meta Certificates
                  </span>{" "}
                  and advanced Udemy certifications in modern web development.
                </p>
              </div>
  ...
  return (
    <section id="skills" className="py-32 relative overflow-hidden bg-black">
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl animate-pulse"
  ...
  const projects = [
    {
      ...
      live: "https://vidyavault.netlify.app/",
      github: "https://github.com/Saurabh-Galgale/VidyaVault-frontend",
    },
    {
                ...
                <div className="relative p-8">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.tech.map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 rounded-full bg-gray-800/50 text-gray-300 text-sm font-medium border border-gray-700 group-hover:border-cyan-500/30 transition-all"
                      >
                        {tech}
                      </span>
                    ))}
...
const Contact = () => {
  ...
  useEffect(() => {
    const flag = localStorage.getItem("contactFormSubmitted");
    if (flag === "true") {
  ...
  const handleSubmit = async (e) => {
    ...
    // prevent double / repeated submits
    if (isSubmitting || hasSubmittedOnce) {
    ...
    try {
      const res = await fetch("https://formspree.io/f/xeoyzqlw", {
        method: "POST",
        headers: {
      ...
      // mark this user as "already submitted" in this browser
      setHasSubmittedOnce(true);
      ...
      // auto-clear only success/error banners (optional)
      setTimeout(() => {
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "galgalesaurabh18@gmail.com",
      href: "mailto:galgalesaurabh18@gmail.com",
    },
    {
      icon: Github,
      label: "GitHub",
      value: "github.com/Saurabh-Galgale",
      href: "https://github.com/Saurabh-Galgale",
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
      value: "linkedin.com/in/saurabh-galgale",
      href: "https://www.linkedin.com/in/saurabh-galgale/",
    },
  ];
        ...
        >
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-400 mt-6 max-w-2xl mx-auto">
              Open to exciting remote opportunities worldwide. Let's build
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="p-8 rounded-3xl bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-xl border border-gray-800">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  {hasSubmittedOnce ? (
                    <span>Message Already Sent</span>
                  ) : isSubmitting ? (
                    <>
                ...
                {submitStatus === "already-submitted" && (
                  <div className="flex items-center space-x-2 p-4 rounded-xl bg-yellow-500/10 border border-yellow-500/30 text-yellow-400">
                    <span>
                      You have already sent a message from this browser.
                    </span>
                  </div>
                )}
